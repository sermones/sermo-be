...
// FindByDateSentenceBookmark 특정 날짜의 문장 북마크 조회 (인증 필요)
...
// @Success 200 {array} SentenceBookmarkResponse "해당 날짜의 문장 북마크 목록"
// @Failure 400 {object} map[string]interface{} "잘못된 날짜 형식"
// @Failure 401 {object} map[string]interface{} "인증 실패"
// @Router /bookmark/sentence/date [get]
func FindByDateSentenceBookmark(c *fiber.Ctx) error {
